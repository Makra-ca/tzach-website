      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              try {
                // Skip preloader on admin/register routes or if already shown on this device
                if (window.location.pathname.startsWith('/admin') || window.location.pathname.startsWith('/register') || localStorage.getItem('lyo-preloader-shown')) {
