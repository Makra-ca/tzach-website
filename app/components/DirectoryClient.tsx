        ...
        <div className="space-y-2 pt-4 border-t border-gray-100">
          {house.phone && (
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <a href={`tel:${house.phone.replace(/\D/g, '')}`} className="hover:text-[#d4a853] transition-colors">{house.phone}</a>
            </div>
          )}
          {house.email && (
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <a href={`mailto:${house.email}`} className="hover:text-[#d4a853] transition-colors break-all">{house.email}</a>
            </div>
          )}
          {house.website && (
            <a
              ...
              className="inline-flex items-center gap-1.5 text-sm font-medium text-[#0f172a] hover:text-[#d4a853] transition-colors"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
