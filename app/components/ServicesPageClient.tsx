          ...
          <div className="relative z-10 h-full max-w-6xl mx-auto px-4 flex items-center">
            <div className="max-w-2xl text-white hero-animate">
              ...
              <p className="text-xl text-gray-300 leading-relaxed">
                Chabad Houses offer a wide range of programs and services for the Jewish community.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {services.map((service, index) => (
                <AnimatedSection
                  ...
                  skipPreloaderDelay
                >
                  <div className="bg-white rounded-xl shadow-md p-8 hover:shadow-xl transition-shadow h-full">
                    <div className="w-16 h-16 bg-[#0f172a]/10 rounded-full flex items-center justify-center text-[#0f172a] mb-6">
          ...
          <div className="max-w-4xl mx-auto px-4 text-center">
            <AnimatedSection direction="slideLeft" skipPreloaderDelay>
              ...
              <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
                Our Chabad Houses throughout the NYC Metro area offer these services and many more.
                Find your local Chabad and connect with your community today.
              </p>
            </AnimatedSection>
